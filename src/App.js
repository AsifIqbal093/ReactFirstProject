      ...
      <ThemeProvider theme = {theme}>
        ...
        <div className={classes.wrapper}>
            <Typography variant="h4" className={classes.bigSpace} color="primary">
              At Rocket.io, we are passionate about Softwares and Business Solutions.
            </Typography>
            <Typography variant="h5" className={classes.littleSpace} color="primary">
              Lead with open source and keep your workflow going with the right team collaboration platform.
              Made for team collaboration, DevOps and customer engagement.Self managed or in the cloud, you
               can customize your workspace with different user permissions, unlimited integrations and 
               centralize all the data your teams, customers and other stakeholders need.
            </Typography>
        </div>
